...
extern IntSet* DFA_get_State_Match_Table(DFA dfa);

extern int** DFA_get_Transition_Function(DFA dfa);

extern int DFA_get_State_Match(DFA dfa, IntSet set);

extern IntSet DFA_get_State_Set (DFA dfa, int i );

extern void DFA_set_State_Match(DFA dfa, IntSet state, int i);

extern void DFA_Set_NFA_Translated(DFA dfa, bool value);
